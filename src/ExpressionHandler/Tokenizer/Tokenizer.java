...
public class Tokenizer {
    public static List<Token> tokenize(String formula){
        if (formula.startsWith("=")){
            ...
            throw new IllegalStateException("Formula Cell initialized but no formula found.");
        }
        ...
        while (pos < formula.length()){
            ...
            if (matcher.lookingAt()){
                ...
                if (matcher.group(1) != null){
                    ...
                    tokens.add(new Token(TokenType.ARG_SEPARATOR, tokenText));
                }
            }
            else {
                throw new IllegalStateException("Unrecognized token at: " + formula.substring(pos));
            }
        }
